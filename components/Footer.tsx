    ...
    <footer className="bg-secondary px-6 py-20">
      <div className="mx-auto max-w-7xl">
        <div className="mb-32">
          ...
          <p className="max-w-xs text-text-secondary/10 text-sm leading-relaxed font-(family-name:--font-inter)">
        ...
        <div className="pt-8 border-t border-border/30">
          <p className="text-text-secondary/10  text-sm opacity-80 font-(family-name:--font-inter)">
